...
class Calculator {
    ...
    private fun String.getValue() = variables.getOrElse(this) { this.toBigIntegerOrNull() ?: throw Exception("Unknown variable") }
    private fun String.isIdentifier() = IDENTIFIER.toRegex().matches(this)
